  ...
  return (
    <View className="flex-1 bg-background">
      <View className="flex-row items-center justify-between px-6 py-4 border-b border-border/40">
        ...
        <TouchableOpacity
          onPress={onClose}
          className="h-10 w-9 items-center justify-center rounded-full bg-surface-2"
        >
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="px-4 py-5">
          <Text className="text-sm font-bold uppercase tracking-wider text-default-500 mb-4">
            Quick Select
          </Text>
                ...
                <Card.Body>
                  <View className="flex-row items-center justify-between">
                    <View className="flex-1">
                      <Text className="text-xs font-bold uppercase tracking-wider text-default-500 mb-1.5">
                        Start Date
                      </Text>
